...
This page opens real New York Harbor NOAA BlueTopo elevation, uncertainty, and
contributor layers from verified source GeoTIFFs, then reads real RAT sidecars
for contributor metadata. Elevation is shown with hillshade and contours;
uncertainty and contributor IDs are plotted as their own source layers.
...
```{r elevation-plot, eval=bt_real_examples_enabled(), fig.cap="Actual NOAA BlueTopo source data: New York Harbor elevation layer with hillshade and contours.", fig.alt="Hillshaded real BlueTopo elevation layer with contours."}
