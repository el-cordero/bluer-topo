...
```{r elevation-figure, eval=bt_real_examples_enabled(), fig.cap="Actual NOAA BlueTopo source data: elevation raster from verified GeoTIFFs with AOI overlay.", fig.alt="Real BlueTopo elevation raster with the example AOI outline."}
