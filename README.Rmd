...
uses synthetic miniature BlueTopo fixtures so the rendered tables and figures are
reproducible without downloading NOAA data during documentation builds.
