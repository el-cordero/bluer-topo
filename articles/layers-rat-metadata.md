...
by `terra`/GDAL metadata inspection when available. This is provenance
text, not a datum conversion.
...
Use a domain-appropriate vertical-datum transformation outside
`bluertopo` when an analysis requires one.
